...
async def list_assets(
    ...
    search: str | None = Query(None, description="Search hostname, IP, serial, manufacturer"),

    discovery_source: str | None = Query(None, description="Filter by SNMP, WINRM, PING"),

    device_type: str | None = Query(None, description="Filter by device type"),

    asset_status: str | None = Query(None, alias="status", description="Filter by status"),
