...
const techStack = [
  { category: "Backend", items: ["Python 3.12", "FastAPI", "SQLAlchemy 2.0", "PostgreSQL 16", "Redis 7", "Celery"] },
  { category: "Frontend", items: ["React 19", "TypeScript", "Vite 6", "Tailwind CSS v4", "Recharts", "TanStack Table"] },
  { category: "Discovery", items: ["pysnmp-lextudio", "pypsrp", "python-nmap", "ICMP/ARP scanning"] },
  { category: "Security", items: ["PyJWT", "bcrypt", "passlib", "TOTP MFA", "LDAP/AD"] },
  { category: "Infrastructure", items: ["Docker", "Nginx", "Leaflet.js"] },
];
